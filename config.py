...
# Tor / SOCKS proxy settings (works with system Tor, Docker, Orbot on Android)
TOR_SOCKS_HOST = _clean_env("TOR_SOCKS_HOST", "127.0.0.1")
TOR_SOCKS_PORT = _clean_env("TOR_SOCKS_PORT", "9050")
TOR_SOCKS_URL = f"socks5h://{TOR_SOCKS_HOST}:{TOR_SOCKS_PORT}"
